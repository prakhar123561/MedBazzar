...
export default function ProductList(props) {
    ...
    var productsBYSub = props.productsBySub
                ...
                <div style={{
                    ...
                    <Grid container spacing={1} style={{ maxWidth: '240px' }} >
                        ...
                        <Grid item xs={12} style={{
                            marginLeft: 8, marginRight: 8, overflow: "hidden", cursor: 'pointer',
    ...
    const ProductDetailBySub = () => {
        return productsBYSub?.map((item) => {
            return (<div >
                <div style={{
                    // width: "100%",
                    // height: "auto",
    ...
    return (<div>
        ...
        {props.status?<div style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row', width: '100%', marginLeft: '2%', justifyContent: 'flex-start', width: "auto", marginTop: '3%', background: "#fff" }}>
           {ProductDetailBySub()}
            
        </div>
        :<div style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row', width: '100%', marginLeft: '2%', justifyContent: 'flex-start', width: "auto", marginTop: '3%', background: "#fff" }}>
        {ProductDetail()}
